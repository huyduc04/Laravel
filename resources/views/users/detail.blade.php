...
<head>
    ...
    <title>Chi tiết sản phẩm - LARAVEL ASM</title>
</head>
...
<nav class="custom-navbar navbar navbar-expand-md navbar-dark bg-dark" aria-label="Furni navigation bar">
    <div class="container">
        <a class="navbar-brand" href="{{ route('users.home') }}">Heart Daily<span>.</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsFurni">
            ...
            <ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('postLogin') }}"><img src="../asset_users/images/user.svg" alt="User"></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href=""><img src="../asset_users/images/cart.svg" alt="Cart"></a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-lg-6">
            <img src="{{ asset($product->images) }}" class="img-fluid" alt="Hình ảnh sản phẩm">
        </div>
        <div class="col-lg-6">
            <h1>{{ $product->name }}</h1>
            <p class="text-danger h4">{{ $product->price }}đ</p>
            <p>{{ $product->description }}</p>
            <a href="{{ route('users.home') }}" class="btn btn-primary">Quay lại trang chủ</a>
        </div>
    </div>
</div>
